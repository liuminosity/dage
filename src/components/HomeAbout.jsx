          ...
          <div className="container">
              <div className="row">
                  <div className="col-lg-12 text-center">
                      ...
                      <p className="text-faded" style={{fontSize:'28px', fontWeight:'400'}}>112 corporate emails are sent out every year. Each email has the potential to leak corporate secrets, confidential client information, or PR-damaging content. With no way to intelligently and efficiently monitor these messages, companies cannot proactively reduce their risk of damaging emails being leaked out.</p>
